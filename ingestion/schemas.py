...
AttackInjector), so simulated CSVs can be loaded straight into these
models with zero renaming. This is also the boundary where real
BLE-connected BMS hardware would eventually plug in — a real ingestion
client would need to produce records matching these same shapes.
