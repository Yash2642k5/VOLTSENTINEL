...
class SimulatorConfig:
    ...
    # Thermal behaviour
    ambient_temp_mean_c: float = 32.0    # ambient baseline
    ...
    # Live SoC / range estimation
    avg_kwh_per_km: float = 0.06            # ev-class energy consumption
    ...
    demo_stressed_vehicle_index: Optional[int] = 0   # index into vehicle_ids
    ...
    depot_gps_jitter_deg: float = 0.003
    ...
    # Driver identity / vehicle assignment
